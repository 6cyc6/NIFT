...
model = VNNOccScfNetMulti(latent_dim=256, o_dim=opt.o_dim, sigmoid=True).cuda()
...
training.train_occ_scf(model=model_parallel, train_dataloader=train_dataloader, val_dataloader=val_dataloader, epochs=opt.num_epochs,
